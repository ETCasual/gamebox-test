...
//                                 .open(version)
//                                 .then((cache) =>
//                                     cache.put(HTMLToCache, clonedResponse)
//                                 );
//                         }
//                     } else {
...
//                                         if (
//                                             new RegExp(
//                                                 removeHash(event.request.url)
//                                             ).test(removeHash(asset.url))
//                                         ) {
//                                             cache.delete(asset);
//                                         }
//                                     })
...
//         return (
//             /\?hash=(.*)/.exec(firstUrl)[1] === /\?hash=(.*)/.exec(secondUrl)[1]
//         );
//     }
// }
