                            ...
                            <div className="row">
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        ...
                                        purchase or payment of any kind required
                                        to enter the tournaments for the prizes.
                                    </p>
                                    <p className="description">
                                        By entering the tournaments, all
                                        entrants agree to abide by and be bound
                                        by these official prizes and tournament
                                        rules and consent to the use of their
                                        personal information to administer the
                                        prize and/or tournament.
                                    </p>
                                    <p className="description">
                                        ...
                                        especially in case of any suspicion of
                                        fraud and violation of the prize and
                                        tournament rules.
                                    </p>
                                </div>
                                {/* PARTICIPANTS */}
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        The prizes and tournaments is open to
                                        all registered users of GameBox and
                                        Froyo.Games, who have reached the age of
                                        18 or the applicable age of the majority
                                        (which is higher) at the time of entry
                                        ("Participants") and where local
                                        regulations do not prevent in any other
                                        way participation in free tournaments
                                        with NFT’s or Tokens as the prize.
                                    </p>
                                </div>
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        The featured and premium prize duration
                                        is shown in the GameBox platform as the
                                        number of tickets the prize has
                                        collected over the maximum number of
                                        tickets (the draw condition) of the
                                        prize. It displays the total number of
                                        tickets that the prize has accumulated
                                        until it reaches its draw condition and
                                        a winner is chosen for the prize.
                                    </p>
                                    <p className="description">
                                    ...
                                    <p className="description">
                                        It is GameBox's sole discretion to
                                        announce a new prize and/or tournament
                                        or cancel upcoming prize and/or
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        To enter a Prize/Tournament, user needs
                                        to:
                                    </p>
                                    <ul className="description pb-3 px-3 m-0">
                                        <li>
                                            Register by opening an account with
                                            www.froyo.games. In order to
                                            register, Participants need to
                                            accept and agree to the Privacy
                                            Policy, Terms and Conditions and the
                                            Prize and Tournament Rules and be at
                                            least 18 years of age.
                                        </li>
                                        <li>
                                            Use GameBox platform to earn tickets
                                            ("Tickets") that are each worth one
                                            (1) entry into the prize played.
                                            Tickets can be earned in various
                                            ways, including (i) participating in
                                            tournaments, (ii) using the spinner,
                                            (iii) other defined activities in
                                            the application. Tickets have no
                                            cash value.
                                        </li>
                                        <li>
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <ul className="description pb-3 px-3 m-0">
                                        <li>
                                            All prizes are awarded to the
                                            winners by the Prize Sponsor.
                                            Winners must accept the Prize as
                                            awarded by the Prize Sponsor or the
                                            Prize will be forfeited. Prizes
                                            cannot be transferred or
                                            substituted, except at the Prize
                                            Sponsor's sole discretion. Failure
                                            to verify or declare a winner or
                                            otherwise unclaimed Prizes will
                                            result in such Prizes being
                                            forfeited and not awarded.
                                        </li>
                                        <li>
                                            Selected entrants are notified after
                                            the prize and/or tournament via
                                    ...
                                    <ul className="description pb-3 px-3 m-0">
                                        ...
                                        <li>
                                            ...
                                            at the moment of the draw are
                                            entered into the prize.
                                        </li>
                                        <li>
                                            The Prize winner is announced
                                            through the GameBox platform, right
                                            after the Prize Draw.
                                        </li>
                                        <li>
                                            Odds of winning the Prize depends
                                            upon the number of eligible entries
                                            received by the Prize Sponsor during
                                            the Prize and Tournament Period.
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="description pb-3 px-3 m-0">
                                        <li>
                                            ...
                                            additional tickets with ads or gems
                                        ...
                                        <li>
                                            ...
                                            change the prize and/or duration of
                                            the prize at its own discretion.
                                        </li>
                                        <li>
                                    ...
                                    <ul className="description pb-3 px-3 m-0">
                                        ...
                                        <li>
                                            ...
                                            promotional campaigns cannot be
                                            claimed by Prize Winners immediately
                                            unless stated by Prize Sponsor.
                                            Prize Winners will need to wait for
                                            the Prize to be minted and/or
                                            promotional campaign to end before
                                            the Prize can be claimed. It is the
                                            Prize Sponsor’s sole discretion to
                                            determine the duration of when the
                                            Prize will be minted and/or
                                        ...
                                        <li>
                                            ...
                                            Conditions, Privacy Policy and Prize
                                            and Tournament Rules of Gamebox.
                                        </li>
                                        <li>
                                            Once participants claim their Prize,
                                            the participant (i) confirms
                                            compliance with the tournament
                                            rules, and (ii) releases the
                                            Tournament Parties and Prize Sponsor
                                            from any and all liability in
                                            connection with the Tournament or
                                            the acceptance, awarding, use or
                                            misuse of any Prize; The Prize
                                            Sponsor reserves the right to verify
                                            any of the foregoing requirements
                                            including, without limitation, proof
                                            of age and jurisdiction of residence
                                            prior to awarding the Prize. If an
                                            entrant’s name is drawn and they are
                                            unqualified, the Prize may be
                                            forfeited in the Prize Sponsor’s
                                            sole discretion.
                                        </li>
                                        <li>
                                            Any error in submission will result
                                        ...
                                        <li>
                                            ...
                                            expire 180 days after the first
                                            prize announcement.
                                        </li>
                                        <li>
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        The Prize Sponsor reserves the right, in
                                        its sole discretion, to suspend or
                                        cancel the prize and/or tournament at
                                        any time if, for any reason the prize
                                        and/or tournament is not capable of
                                        running as planned, including, without
                                        limitation, infection by computer virus,
                                        bugs, tampering, unauthorised
                                        intervention, fraud, technical failures,
                                        or any other causes which corrupt or
                                        affect the administration, security,
                                        fairness, integrity or proper conduct of
                                        the prize and/or tournament
                                        ("Interruptions"). The Prize Sponsor
                                        reserves the right to cancel, at its
                                        sole discretion, to suspend and/or
                                        modify the prize and/or tournament, or
                                        any part of it and disqualify any
                                        individual who is responsible for any
                                        Interruptions, tampering with the entry
                                        process, the operation of the prize
                                        and/or tournament, or who is otherwise
                                        in violation of these Official Prize
                                        and/or Tournament Rules. If terminated,
                                        the Prize Sponsor may, in its sole
                                        discretion, determine the winners from
                                        among all eligible Entries received up
                                        to the time of such action using the
                                        procedures outlined herein. Each prize
                                        will be awarded "as is" and without
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        ...
                                        and/or Tournament Rules, Intellectual
                                    ...
                                    <p className="description">
                                        ...
                                        GameBox’s business or the prize and/or
                                        tournament.
                                    </p>
                                    <p className="description">
                                        ...
                                        with the prize and/or tournament in all
                                        publicity, marketing and materials.
                                    </p>
                                    <p className="description">
                                        The Participant shall not publicise his
                                        or her involvement in the prize and/or
                                    ...
                                    <p className="description">
                                        ...
                                        Prize (the Products) each Participant:
                                        (i) confirms the grant by the
                                        Participant to GameBox of a worldwide,
                                        perpetual, royalty free licence in the
                                        Intellectual Property Rights in the
                                        Products or Prize and/or Tournament
                                        entry, (ii) waives any moral rights and
                                        like rights the Participant has in
                                        relation to the Products or GameBox
                                        entry so that GameBox shall be entitled
                                        to use the Products or GameBox entry in
                                        any and all media at no cost to GameBox
                                        and (iii) warrants to GameBox that the
                                        Products or GameBox entry: (a) are
                                        personal and related specifically to the
                                        Participant; (b) are owned and
                                        controlled by the Participant and that
                                        the Participant has the right, power and
                                        authority to grant the rights set out in
                                        these terms and conditions; (c) will not
                                        infringe the Intellectual Property
                                        Rights, privacy or any other rights of
                                        any third party; (d) will not contain
                                        anything which is untrue, defamatory,
                                        obscene, indecent, harassing or
                                        threatening; (e) do not violate any
                                        ...
                                        Prize and/or Tournament Rules.
                                    </p>
                                    <p className="description">
                                        For the avoidance of doubt, all rights
                                        relating to the Prize and/or Tournament
                                        (including the name, title and format of
                                        the Prize and/or Tournament ) will vest
                                        exclusively in GameBox for our own use
                                        (in our absolute discretion). Unless
                                        otherwise stated, prize and/or
                                        tournament entries will not be returned
                                        to you.
                                    </p>
                                </div>
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        ...
                                        and/or Tournament: hardware or software
                                        errors; faulty computer, cable,
                                        ...
                                        Tournament Platform in whole or in part
                                        for any reason; traffic congestion on
                                        the Internet or the Prize and/or
                                        Tournament Platform's servers;
                                        unauthorised human or non-human
                                        intervention of the operation of the
                                        Prize and/or Tournament, including
                                        without limitation, unauthorised
                                        tampering, hacking, theft, virus, bugs,
                                        or worms; or destruction of any aspect
                                        of the Prize and/or Tournament, or loss,
                                        miscount, misdirection, inaccessibility
                                        or unavailability of an email account
                                        used in connection with the Prize and/or
                                        Tournament. The Prize and/or Tournament
                                        Parties are not responsible for any
                                        printing, typographical, technical,
                                        computer, network or human error which
                                        may occur in the administration of the
                                        Prize and/or Tournament, the processing
                                        of Tickets or entries, or in any Prize
                                        and/or Tournament-related materials. Use
                                        of the Prize and/or Tournament Platform
                                        is at the user's own risk. The Prize
                                        and/orTournament Parties are not
                                        responsible for any personal injury or
                                        property damage or losses of any kind
                                        which may be sustained to user's or any
                                        other person's computer equipment
                                        resulting from participation in the
                                        Prize and/or Tournament. By
                                        participating in the Prize and/or
                                        Tournament, entrants agree: (i) to
                                        ...
                                        Prize and/or Tournament and their
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        The Prize Sponsor and its authorised
                                        agents will collect, use, and disclose
                                        the personal information provided upon
                                        registration and entry into the Prize
                                        and/or Tournament for the purposes of
                                        administering the Tournament and Prize
                                        fulfilment, in accordance with the Prize
                                        Sponsor's Privacy Statement. By
                                        accepting a Prize, winners consent to
                                        the publication and use of their name,
                                        statements, profile pictures,
                                        photographs, image and/or likeness in
                                        any form, manner or media whether now
                                        known or hereafter devised, including,
                                        without limitation, in print, radio,
                                        television, in the Prize and/or
                                        Tournament Platform, and on the Internet
                                ...
                                <div className="col-12 mb-4">
                                    ...
                                    <p className="description">
                                        The Prize Sponsor is not responsible for
                                        any other costs associated with claiming
                                        or using the Prize. The winners are
                                        solely responsible for the reporting and
                                        payment of any and all taxes, if any,
                                        that may result in claiming the prizes
                                        in this Prize and/or Tournament. Prize
                                        and/or Tournament Winner understands
                                        that the prize received might be reduced
                                        by tax obligations that arise for the
                                        Prize Sponsor related to awarding such
                                        prize. Decisions of the Prize Sponsor
                                        are final on all matters relating to the
                                        Prize and/or Tournament, including
                                        matters of fact, interpretation,
                                        eligibility, procedure and fulfilment in
                                        respect to the Prize and/or Tournament.
                                        The Prize Sponsor reserves the right at
                                        any time to cancel or modify the Prize
                                        and/or Tournament or to modify or
                                        supplement these Official Prize and/or
                                        Tournament Rules without notice, in its
                                        sole discretion, subject to applicable
                                        law.
                                    </p>
                                    <p className="description">
                                        ...
                                        Sponsor in connection with the Prize
                                        and/or Tournament, shall be governed by,
                                        and construed in accordance with, the
                                        laws in effect in Malaysia, without
                                        giving effect to any choice of law or
                                        conflict of law rules. Any waiver of any
                                        obligation hereunder by the Prize
                                        Sponsor does not constitute a general
                                        waiver of any obligation to entrants.
                                        The Prize Sponsor reserves the right to
                                        update or modify these Rules at any
