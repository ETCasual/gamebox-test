...
const Footer = () => {
    return (
        <div className="footer d-flex flex-column align-items-center justify-content-center">
            <ul className="list-unstyled d-flex align-items-cemter mb-0">
                {/* FACEBOOK */}
                <li>
                    <Link
                        target="_blank"
                        to={{
                            pathname: "https://www.facebook.com/EsportsMini/",
                        }}
                    >
...
c0-5.964,2.833-15.303,15.301-15.303L71.56,21.81v12.51h-8.151c-1.337,0-3.217,0.668-3.217,3.513v7.585h11.334L70.201,58.294z"
                ...
                <li>
                    <Link
                        ...
                        target="_blank"
                        to={{
                            pathname: "https://www.instagram.com/esportsmini/",
                        }}
                    >
...
C86.391,45.366,88.664,43.005,90.461,40.316L90.461,40.316z"
            ...
            <p className="mt-3 mb-2 copyright">
                © {new Date().getFullYear()} ESportsMini. All Rights Reserved.
            </p>
            <ul className="list-unstyled paths d-flex align-items-center mb-0">
                <li>
